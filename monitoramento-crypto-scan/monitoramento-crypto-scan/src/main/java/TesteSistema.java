                                         ...
                                         do {
                                            ...
                                            """);
                                             ...
                                             switch (opcaoDados){
                                                 ...
                                                 case 2:
                                                     List<Medida> medidasInseridas = sql.query("SELECT medida, fkComponente, fkSetup,  DATE_FORMAT(dataHoraMedida, '%d %c %Y %T') AS 'dataHoraMedida' FROM Medida WHERE fkSetup = ?" ,
                                                             new BeanPropertyRowMapper<>(Medida.class), idSetup);
