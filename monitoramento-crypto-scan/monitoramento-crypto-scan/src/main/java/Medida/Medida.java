...
public class Medida {
    ...
    public Medida(Integer idMedida, Float medida, String dataHoraMedida, Integer fkComponente, Integer fkSetup) {
    ...
    public String toString() {
        return String.format("""
                ...
                |                                        MEDIDAS                                        |
                -----------------------------------------------------------------------------------------
                Medida: %f -  Componente: %d - Setup: %d -  DataHoraMedida: %s                                      
                -----------------------------------------------------------------------------------------
                """,medida, fkComponente, fkSetup, dataHoraMedida);
